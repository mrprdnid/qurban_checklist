@extends('layouts.app')
@section('title', 'Checklist Sapi — ' . $hewan->nomor_urut)

@section('content')
<div class="d-flex align-items-center gap-2 mb-3">
    <a href="{{ route('checklist.sapi') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i></a>
    <h5 class="fw-bold mb-0">Checklist Sapi</h5>
</div>
...
<div class="card border-0 shadow-sm mb-3">
    <div class="card-body py-2 px-3">
        <div class="d-flex align-items-center gap-3">
            ...
            <span class="badge bg-warning text-dark">Sapi</span>
        </div>
...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body p-0">
        <form action="{{ route('checklist.sapi.update', $hewan) }}" method="POST">
            @csrf @method('PATCH')
            @foreach([
